 ...
 * Could be extended to i18n etc.FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET
 */
return array(
	...
	"FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET" => "Your account is not activated yet. Please click on the confirm link in the mail and chek youre spam folder if you do not see it.",
	...
	"FEEDBACK_USER_DELETE_NO_ID" => "could not fetch id from the database",
