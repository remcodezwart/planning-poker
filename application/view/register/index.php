<!-- echo out the system feedback (error and success messages) -->
    ...
    <!-- login box on left side -->
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action">
            ...
            <input type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" placeholder="Username (letters/numbers, 2-64 chars)" required="true" /><br />
            <input type="text" name="user_email" placeholder="email address (a real address)" required="true" /><br />
            <input type="text" name="user_email_repeat" placeholder="repeat email address (to prevent typos)" required="true" /><br />
            <input type="password" name="user_password_new" pattern=".{6,}" placeholder="Password (6+ characters)" required="true" autocomplete="off" /><br />
